...
USER_INFO_THEME_PROMPT_COLOR=${POWERLINE_USER_INFO_COLOR:=26}
...
SCM_THEME_PROMPT_CLEAN_COLOR=${POWERLINE_SCM_CLEAN_COLOR:=124}
...
HOST_THEME_PROMPT_COLOR=${POWERLINE_HOST_COLOR:=94}
...
POWERLINE_PROMPT=${POWERLINE_PROMPT:="user_info hostname scm python_venv ruby node cwd"}
