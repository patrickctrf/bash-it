...
USER_INFO_THEME_PROMPT_COLOR=${POWERLINE_USER_INFO_COLOR:=52}
...
POWERLINE_COMPACT_BEFOR_FIRST_SEGMENT=${POWERLINE_COMPACT_BEFORE_FIRST_SEGMENT:=1}
...
SCM_THEME_PROMPT_CLEAN_COLOR=${POWERLINE_SCM_CLEAN_COLOR:=92}
SCM_THEME_PROMPT_DIRTY_COLOR=${POWERLINE_SCM_DIRTY_COLOR:=88}
SCM_THEME_PROMPT_STAGED_COLOR=${POWERLINE_SCM_STAGED_COLOR:=30}
SCM_THEME_PROMPT_UNSTAGED_COLOR=${POWERLINE_SCM_UNSTAGED_COLOR:=178}
...
CWD_THEME_PROMPT_COLOR=${POWERLINE_CWD_COLOR:=238}
...
HOST_THEME_PROMPT_COLOR=${POWERLINE_HOST_COLOR:=88}
...
POWERLINE_PROMPT=${POWERLINE_PROMPT:="python_venv user_info hostname ruby node cwd scm"}
